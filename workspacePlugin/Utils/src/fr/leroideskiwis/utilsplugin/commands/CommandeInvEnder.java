...
public class CommandeInvEnder implements CommandExecutor {


	
	private Main main;

	public CommandeInvEnder(Main main) {
		this.main = main;
	}
	...
	public boolean onCommand(CommandSender s, Command arg1, String arg2, String[] args) {
		if(main.SenderIsPlayer(s)){
			...
			if(args.length != 0){
				...
				Inventory inv = Bukkit.createInventory(null, 9*3, "§8Inventaire de l'enderchest de §7"+target.getName());
