...
public class CommandTpAccept implements CommandExecutor {
	...
	public boolean onCommand(CommandSender s, Command arg1, String arg2, String[] args) {
		...
		if(main.senderIsPlayer(s)){
			...
			if(This == null){
				p.sendMessage("§cVous n'avez pas de demandes de téléportation en attente !");
				return true;
			} else {
				p.sendMessage("§7Demande de téléportation accepter !");
				p.sendMessage("§7Téléportation en cours...");
				This.getRequester().sendMessage("§c"+p.getName()+" §7a accepté votre demande de téléportation !");
